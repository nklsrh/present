namespace MetaSheets {
	...
	public class StringUtilities {
		/// <summary>
		/// Format string template {0},{1},.. Improved version of string.Format() which supports '{' in code templates
		/// </summary>
		...
		/// <summary>
		/// Returns the camelCase of the input string
		/// </summary>
		/// <param name="inp"></param>
		/// <returns></returns>
		public static string GetCamelCase(string inp) {
			...
			//Split by words and convert to camelCase
